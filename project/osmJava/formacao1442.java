...
public class formacao1442 extends Formacao{
    public formacao1442(List<Jogador> players,String equipa) throws NotEnoughPlayerException{
        if(players.size()<14) throw new NotEnoughPlayerException("Numero total de jogadores insuficiente");
            ...
            super.setPosicoes(Arrays.asList("GuardaRedes","Defesa","Defesa","Lateral","Lateral"
                    ,"Lateral","Lateral","Medio","Medio","Avancado","Avancado"));
            super.setEquipa(equipa);
            super.setSuplentes(players);
        }
    }
    public formacao1442(formacao1442 f){
        super(f);
    }
    public GameTeams clone(){
        return (GameTeams) new formacao1442(this);
    }
}
